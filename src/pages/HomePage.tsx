          ...
          >
            <div className="flex justify-center mb-8">
              <div className="relative">
                <img src="/Premium Access Zone LOGO.png" alt="Premium Access Zone" className="h-32 w-auto" />
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <img src="/Premium Access Zone LOGO.png" alt="Premium Access Zone" className="h-10 w-auto" />
                <h3 className="text-xl font-bold text-white">Premium Access Zone</h3>
              </div>
