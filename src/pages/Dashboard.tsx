...
const Dashboard: React.FC = () => {
 ...
 const quickActions = [
    ...
    {
      title: 'Social Tasks',
      description: 'Complete tasks to earn more points',
      icon: Target,
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between relative z-10">
          ...
          >
            ...
            >
              <img src="/Premium Access Zone LOGO.png" alt="Premium Access Zone" className="h-24 w-auto" />
            </motion.div>
          </motion.div>
        </div>
      </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {quickActions.map((action, index) => (
              ...
              >
                <div className="bg-white/10 rounded-xl p-4 sm:p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 overflow-hidden">
